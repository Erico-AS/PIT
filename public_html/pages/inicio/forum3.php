...
$forumId = 3; // Defina o ID do fórum específico
    ...
    <main>
        ...
        <div class="titulocontainer">
            ...
            <button class="add-button">
                ...
                if (isset($_SESSION['nome_user']) && !empty($_SESSION['nome_user'])) {
                    echo "<a href='publicar.php?forum_id=3'>Adicionar uma publicação</a>";
                } else {
        ...
        <div class="forumcontainer">
            ...
            <div class="sticker-button">
                ...
                // Verificar se o usuário está logado antes de exibir o botão de publicação
                if (isset($_SESSION['nome_user']) && !empty($_SESSION['nome_user'])) {
                    echo "<button onclick=\"window.location.href = 'publicar.php?forum_id=3';\"><img src=\"../../images/escrevericon.png\" alt=\"Sticker\"></button>";
                } else {
